...
- **Аналитика — готово**: сравнение с прошлым месяцем (плитки + категории), топ-5 трат,
  график по дням (7/14 дней/месяц), прогноз расходов до конца месяца, предупреждения по
  лимитам через бота (ежедневно 12:00 МСК, один раз за месяц на категорию, таблица
  `limit_alerts`). Отложено пользователем: «остаток на день» (сколько можно тратить в
  день, чтобы уложиться в лимиты) — вернуться позже.
