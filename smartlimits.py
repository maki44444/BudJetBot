...
MIN_ACTIVITY_TX = 5       # меньше трат за месяц — учёт не вёлся, а не «стал экономнее»:
ACTIVITY_WINDOW_DAYS = 30 # пересчёт пропускаем, иначе лимиты усыхают на 10% за каждый
                          # месяц простоя и встречают вернувшегося ложными алертами
